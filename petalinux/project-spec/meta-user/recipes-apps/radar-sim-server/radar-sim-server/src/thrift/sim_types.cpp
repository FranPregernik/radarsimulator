...
IncompatibleFileException::IncompatibleFileException(const IncompatibleFileException& other4) : TException() {
  (void) other4;
}
IncompatibleFileException& IncompatibleFileException::operator=(const IncompatibleFileException& other5) {
  (void) other5;
  return *this;
}
